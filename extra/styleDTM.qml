...
<qgis maxScale="0" version="3.36.0-Maidenhead" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories">
  <flags>
  ...
  <elevation symbology="Line" band="1" zscale="1" enabled="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="line" force_rhr="0">
        ...
        <layer id="{10bf9183-a63a-4deb-99d9-948bba4d2f43}" pass="0" enabled="1" locked="0" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="fill" force_rhr="0">
        ...
        <layer id="{21b42540-a06f-4eee-979f-96fdf0e40496}" pass="0" enabled="1" locked="0" class="SimpleFill">
          <Option type="Map">
  ...
  <pipe>
    <provider>
      <resampling zoomedOutResamplingMethod="bilinear" enabled="false" maxOversampling="2" zoomedInResamplingMethod="bilinear"/>
    </provider>
    <rasterrenderer nodataColor="" azimuth="315" band="1" opacity="1" angle="45" type="hillshade" multidirection="0" zfactor="1" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
    ...
    <huesaturation colorizeGreen="128" colorizeStrength="100" invertColors="0" colorizeRed="255" saturation="0" grayscaleMode="0" colorizeBlue="128" colorizeOn="0"/>
